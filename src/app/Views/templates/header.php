    ...
    <header class="flex flex-col w-full sticky top-0 z-50 border-b-2 border-black bg-white">
        ...
        <nav class="flex flex-row justify-between items-center px-4">
            ...
            <section class="flex gap-4">
                ...
                <div class="border border-black flex hidden flex-col fixed h-full p-4 w-full lg:w-1/3" id="btnPanierPop" popover>
            ...
            <section  class="flex gap-4">
                ...
                <div class="border border-black flex flex-row justify-center items-center fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2" id="btnSearchPop" popover>
                    <form action="#">
